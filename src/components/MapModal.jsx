      ...
      >
        ...
        >
          ...
          <div className="absolute top-3 left-3 z-50" style={{
            ...
            boxShadow: '0 4px 12px rgba(0, 0, 0, 0.3), inset 0 1px 3px rgba(255, 255, 255, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.1)',
            minWidth: '200px'
          }}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-base font-bold tracking-wide leading-tight" style={{ 
              color: '#1a0f00',
              textShadow: '0 1px 3px rgba(255, 255, 255, 0.7), 0 0 8px rgba(255, 255, 255, 0.3)',
              fontFamily: 'serif',
              letterSpacing: '0.5px'
            }}>
              {npcName || '位置信息'}
            ...
            <div className="space-y-1 text-xs">
              {zoneName && (
                <div className="flex items-center gap-2" style={{ color: '#2d1b0a' }}>
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
              ...
              {(x !== undefined && y !== undefined) && (
                <div className="flex items-center gap-2" style={{ color: '#2d1b0a' }}>
                  ...
                  <span className="font-medium" style={{ textShadow: '0 1px 2px rgba(255, 255, 255, 0.6)' }}>
                    座標 <span className="font-semibold">({x.toFixed(1)}, {y.toFixed(1)})</span>
                  </span>
                </div>
              )}
            </div>
